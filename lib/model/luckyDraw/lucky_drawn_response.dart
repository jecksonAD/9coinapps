...
LuckyDrawnResponse luckyDrawnResponseFromJson(String str) => LuckyDrawnResponse.fromJson(json.decode(str));

String luckyDrawnResponseToJson(LuckyDrawnResponse data) => json.encode(data.toJson());
...
class LuckyDrawnResponse {
    ...
    factory LuckyDrawnResponse.fromJson(Map<String, dynamic> json) => LuckyDrawnResponse(
